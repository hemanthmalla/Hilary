...
describe('Emails', function() {
    ...
    describe('Templates', function() {
         ...
         */
        it('verify email templates are internationalized', function(callback) {
         ...
         * content templates.
         */
        it('verify error with no meta template', function(callback) {
         ...
         */
        it('verify error with no html or txt template', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users) {
                assert.ok(!err, JSON.stringify(err));
         ...
         */
        it('verify html and txt templates', function(callback) {
            TestsUtil.generateTestUsers(camAdminRestContext, 1, function(err, users) {
                assert.ok(!err, JSON.stringify(err));
