 ...
 */
var setConfig = module.exports.setConfig = function(adminRestContext, enabled, baseUrl, subdomain, ssoKey, callback) {
    var configUpdates = {};
...
var clearConfig = module.exports.clearConfig = function(adminRestContext, callback) {
    ConfigTestUtil.clearConfigAndWait(adminRestContext, null, [
