...
describe('Discussions Authz', function() {
    ...
    describe('#canManageDiscussion', function() {
         ...
         */
        it('verify anonymous cannot manage a discussion', function(callback) {
    ...
    describe('#canShareDiscussion', function() {
         ...
         */
        it('verify anonymous cannot share a discussion', function(callback) {
    ...
    describe('#canPostDiscussionMessage', function(callback) {
         ...
         */
        it('verify anonymous cannot post a discussion message', function(callback) {
    ...
    describe('#canDeleteDiscussionMessage', function(callback) {
         ...
         */
        it('verify anonymous cannot delete a discussion message', function(callback) {
